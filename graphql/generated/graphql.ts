...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'AuthPayload', accessToken: string, refreshToken: string, user: { __typename?: 'User', id: string, email: string, name: string, role: UserRole, isActive: boolean, emailVerified: boolean } } };
...
export type RegisterMutation = { __typename?: 'Mutation', register: { __typename?: 'AuthPayload', accessToken: string, refreshToken: string, user: { __typename?: 'User', id: string, email: string, name: string, role: UserRole, isActive: boolean, emailVerified: boolean } } };
